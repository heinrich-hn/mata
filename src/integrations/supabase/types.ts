  ...
  public: {
    Tables: {
      ...
      bulk_diesel_orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_diesel_orders_bunker_id_fkey"
            columns: ["bunker_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bulk_diesel_orders_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "bulk_diesel_suppliers"
            referencedColumns: ["id"]
          },
        ]
      }
      bulk_diesel_price_entries: {
        Row: {
          created_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_diesel_price_entries_supplier_id_fkey"
            columns: ["supplier_id"]
            isOneToOne: false
            referencedRelation: "bulk_diesel_suppliers"
            referencedColumns: ["id"]
      ...
      daily_dip_records: {
        Row: {
          ...
          created_at: string
          diesel_additions_liters: number
      ...
      driver_disciplinary: {
        ...
        Relationships: [
          {
            foreignKeyName: "driver_disciplinary_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
      ...
      parts_requests: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "parts_requests_tyre_id_fkey"
            columns: ["tyre_id"]
            isOneToOne: false
      ...
      route_rate_history: {
        Row: {
          ...
          previous_rate_type: string | null
          rate_amount: number
          rate_currency: string
          rate_type: string
          route_config_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "route_rate_history_route_config_id_fkey"
            columns: ["route_config_id"]
            isOneToOne: false
            referencedRelation: "route_expense_configs"
            referencedColumns: ["id"]
      ...
      scheduled_inspections: {
        ...
        Relationships: [
          {
            foreignKeyName: "scheduled_inspections_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
            referencedRelation: "vehicles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "scheduled_inspections_completed_inspection_id_fkey"
      ...
      tools: {
        ...
        Relationships: [
          {
            foreignKeyName: "tools_linked_vehicle_id_fkey"
      ...
      trip_order_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "trip_order_documents_trip_order_id_fkey"
