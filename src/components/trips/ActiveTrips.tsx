...
const ActiveTrips = ({
  ...
  const toggleExpenseExpansion = (tripId: string, e?: React.MouseEvent) => {
    e?.stopPropagation();
              ...
              return (
                ...
                >
                  <CollapsibleTrigger asChild>
                    <div className="group flex items-center justify-between gap-3 px-3 py-2 bg-card border rounded-lg hover:bg-accent/50 hover:border-primary/30 transition-all cursor-pointer shadow-xs flex-wrap">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        {weekNumber && (
                          <div className="flex items-center gap-1.5 px-2 py-1 bg-primary/10 rounded-md">
                            ...
                            <span className="text-sm font-bold text-primary tabular-nums leading-none">{weekNumber}</span>
                          </div>
                        )}
