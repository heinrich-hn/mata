...
const CompletedTrips = ({ trips, onView, onRefresh, isLoading = false }: CompletedTripsProps) => {
  ...
  }, [trips, fleetFilter, driverFilter, clientFilter, weekFilter, searchQuery, showMissingRevenueOnly, showFlaggedOnly]);
  ...
  const hasActiveFilters = fleetFilter !== 'all' || driverFilter !== 'all' || clientFilter !== 'all' || weekFilter.length > 0 || searchQuery !== '' || showMissingRevenueOnly || showFlaggedOnly;
