                    ...
                    {isLoading ? (
                        ...
                        inspections.map((insp) => (
                            <button
                                key={insp.id}
                                disabled={linkMutation.isPending}
                                className={`w-full text-left px-3 py-3 rounded-md border transition-colors ${insp.id === currentInspectionId
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-lg max-h-[85vh] flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Search for an existing job card to link to this inspection.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        jobCards.map((jc) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-3 rounded-md border transition-colors ${isLinkedHere
                                            ? "border-primary bg-primary/5"
                                            : isLinkedElsewhere
                                ...
                                >
                                    ...
                                    {isLinkedHere && (
                                        <Badge variant="outline" className="mt-1 text-xs">Linked — tap to unlink</Badge>
                                    )}
                                    {isLinkedElsewhere && (
